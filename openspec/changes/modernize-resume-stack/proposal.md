...
- **BREAKING**: Upgrade Next.js from 14 to 15 and React from 18 to 19.
- **BREAKING**: Upgrade Mantine from v6 to v7 and adopt its new CSS-modules-based styling model.
...
- Replace `@emotion/styled` and `createStyles` usage with CSS modules or Mantine v7 styles.
